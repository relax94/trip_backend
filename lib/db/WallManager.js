...
export class WallManager {
    ...
    getInstances(_model, criteria, fn) {
        if (criteria && fn) {
            return this.Store.findInstances(_model, criteria, fn);
        }
    }

    getPosts(getPostsCriteria, fn) {
        return this.getInstances(Post, getPostsCriteria, fn);
    }

    getComments(getCommentsCriteria, fn) {
        return this.getInstances(Comment, getCommentsCriteria, fn);
    }
